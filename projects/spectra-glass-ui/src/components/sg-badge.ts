...
export class SgBadge extends LitElement {
  static override styles = css`
    ...
    .badge--success {
      background: color-mix(in srgb, var(--sg-color-success, #7fa88d) 70%, transparent);
      color: #fff;
    }

    .badge--warning {
      background: color-mix(in srgb, var(--sg-color-warning, #c4a050) 70%, transparent);
      color: #1a1a1a;
    }

    .badge--error {
      background: color-mix(in srgb, var(--sg-color-error, #d4869f) 70%, transparent);
      color: #fff;
    }

    .badge--info {
      background: color-mix(in srgb, var(--sg-color-info, #6fa0b5) 70%, transparent);
      color: #fff;
    }
    ...
    .badge--success .badge__dot {
      background: var(--sg-color-success, #7fa88d);
    }

    .badge--warning .badge__dot {
      background: var(--sg-color-warning, #c4a050);
    }

    .badge--error .badge__dot {
      background: var(--sg-color-error, #d4869f);
    }
