import {
  ...
  _ as vt,
  a as St,
} from './DocsRenderer-JROSPFPF-CrAFQg6v.js';
import { d as Z, e as C } from './iframe-CIO0rj-b.js';
...
var kt = C({
        ...
        (function (n) {
          ...
          for (
            var l = [
              ...
              g = d.variable[1].inside,
              h = 0;
            h < l.length;
            h++
          )
            g[l[h]] = n.languages.bash[l[h]];
          ...
          a.hooks.add('after-tokenize', function (n) {
            ...
            function g(A, i) {
              for (var s = 1, p = u; p < o.length; p++) {
                var f = o[p],
                  m = f.content;
                if (f.type === 'punctuation' && typeof m == 'string') {
                  if (A.test(m)) s++;
            ...
            for (; u < o.length;) {
              ...
              if (F.type === 'keyword' && F.content === 'mutation') {
                ...
                if (l(['definition-mutation', 'punctuation']) && d(1).content === '(') {
                  ...
                  for (; u < y; u++) {
                    var x = d(0);
                    x.type === 'variable' && (h(x, 'variable-input'), b.push(x.content));
                  }
                  u = y + 1;
                }
                if (
                  ...
                  d(0).content === '{' &&
                  (u++, h(d(0), 'property-mutation'), b.length > 0)
                ) {
                  var S = g(/^\{$/, /^\}$/);
                  if (S === -1) continue;
                  for (var k = u; k < S; k++) {
                    var w = o[k];
                    w.type === 'variable' && b.indexOf(w.content) >= 0 && h(w, 'variable-input');
                  }
                }
              }
            }
      ...
      function t(a) {
        (function (n) {
          ...
          for (
            ...
            var l = u[d],
              g = n.languages.javascript[l];
            n.util.type(g) === 'RegExp' && (g = n.languages.javascript[l] = { pattern: g });
            var h = g.inside || {};
            ((g.inside = h), (h['maybe-class-name'] = /^[A-Z][\s\S]*/));
          }
        })(a);
      }
    },
        ...
        (function (n) {
          ...
          ((l = g(l).source),
            ...
            n.languages.insertBefore(
              'inside',
              'attr-name',
              { spread: { pattern: g(/<SPREAD>/.source), inside: n.languages.jsx } },
              n.languages.jsx.tag,
            ),
            n.languages.insertBefore(
              'inside',
                  ...
                  (typeof S != 'string' &&
                    (S.type === 'tag' && S.content[0] && S.content[0].type === 'tag'
                      ? S.content[0].content[0].content === '</'
                        ? y.length > 0 &&
                          y[y.length - 1].tagName === h(S.content[0].content[1]) &&
                          y.pop()
                        : S.content[S.content.length - 1].content === '/>' ||
                          y.push({ tagName: h(S.content[0].content[1]), openedBraces: 0 })
                      : y.length > 0 && S.type === 'punctuation' && S.content === '{'
                        ? y[y.length - 1].openedBraces++
                        : y.length > 0 &&
                            y[y.length - 1].openedBraces > 0 &&
                            S.type === 'punctuation' &&
                            S.content === '}'
                          ? y[y.length - 1].openedBraces--
                          : (k = !0)),
                  (k || typeof S == 'string') && y.length > 0 && y[y.length - 1].openedBraces === 0)
                ) {
                  var w = h(S);
                  (x < b.length - 1 &&
                    (typeof b[x + 1] == 'string' || b[x + 1].type === 'plain-text') &&
                    ((w += h(b[x + 1])), b.splice(x + 1, 1)),
                    x > 0 &&
                      (typeof b[x - 1] == 'string' || b[x - 1].type === 'plain-text') &&
                      ((w = h(b[x - 1]) + w), b.splice(x - 1, 1), x--),
                    (b[x] = new n.Token('plain-text', w, null, w)));
                }
                S.content && typeof S.content != 'string' && F(S.content);
              }
            };
        ...
        (function (n) {
          ...
          ((n.languages.markdown = n.languages.extend('markup', {})),
            n.languages.insertBefore('markdown', 'prolog', {
              ...
              table: {
                pattern: RegExp('^' + l + g + '(?:' + l + ')*', 'm'),
                inside: {
                  'table-data-rows': {
                    pattern: RegExp('^(' + l + g + ')(?:' + l + ')*$'),
                    lookbehind: !0,
                    inside: {
            ...
            ['url', 'bold', 'italic', 'strike'].forEach(function (x) {
              ['url', 'bold', 'italic', 'strike', 'code-snippet'].forEach(function (S) {
                x !== S &&
                  (n.languages.markdown[x].inside.content.inside[S] = n.languages.markdown[S]);
              });
            }),
            n.hooks.add('after-tokenize', function (x) {
              if (x.language !== 'markdown' && x.language !== 'md') return;
              function S(k) {
                if (!(!k || typeof k == 'string'))
                  for (var w = 0, A = k.length; w < A; w++) {
                    ...
                    if (
                      ...
                      var f = s.content.replace(/\b#/g, 'sharp').replace(/\b\+\+/g, 'pp');
            ...
            n.hooks.add('wrap', function (x) {
              if (x.type === 'code-block') {
                for (var S = '', k = 0, w = x.classes.length; k < w; k++) {
                  var A = x.classes[k],
                    i = /language-(.+)/.exec(A);
                  if (i) {
                    S = i[1];
                ...
                var s = n.languages[S];
                if (s) x.content = n.highlight(y(x.content.value), s, S);
                  ...
                  ((x.attributes.id = p),
                    n.plugins.autoloader.loadLanguages(S, function () {
                      ...
                      f && (f.innerHTML = n.highlight(f.textContent, n.languages[S], S));
                    }));
                }
              }
            }));
          ...
          function y(x) {
            var S = x.replace(h, '');
            return (
              (S = S.replace(/&(\w{1,8}|#x?[\da-f]{1,8});/gi, function (k, w) {
                if (((w = w.toLowerCase()), w[0] === '#')) {
                  var A;
                  return (
                    w[1] === 'x' ? (A = parseInt(w.slice(2), 16)) : (A = Number(w.slice(1))),
                    b(A)
                  );
                } else {
                  var i = F[w];
      ...
      function t(a) {
        (function (n) {
          ...
          ((n.languages.yaml = {
            ...
            string: { pattern: h(g), lookbehind: !0, greedy: !0 },
            number: {
              pattern: h(
  ...
  $t = C({
    '../../node_modules/hastscript/node_modules/property-information/lib/util/merge.js'(e, r) {
      ...
      r.exports = n;
      function n(o) {
        for (var u = o.length, d = [], l = [], g = -1, h, F; ++g < u;)
          ((h = o[g]), d.push(h.property), l.push(h.normal), (F = h.space));
        return new a(t.apply(null, d), t.apply(null, l), F);
      }
    },
  }),
  De = C({
  ...
  rt = C({
    '../../node_modules/hastscript/node_modules/property-information/lib/util/defined-info.js'(
      ...
      function u(l, g, h, F) {
        var b = -1,
          y;
        for (d(this, 'space', F), t.call(this, l, g); ++b < o;)
          ((y = n[b]), d(this, y, (h & a[y]) === a[y]));
      }
      function d(l, g, h) {
        h && (l[g] = h);
      }
    ...
    '../../node_modules/hastscript/node_modules/property-information/lib/util/create.js'(e, r) {
      ...
      function o(u) {
        var d = u.space,
          ...
          S;
        for (x in h)
          ((S = new n(x, F(g, x), h[x], d)),
            l.indexOf(x) !== -1 && (S.mustUseProperty = !0),
            (b[x] = S),
            (y[t(x)] = x),
            (y[t(S.attribute)] = x));
        return new a(b, y, d);
  ...
  qt = C({
    '../../node_modules/hastscript/node_modules/property-information/lib/aria.js'(e, r) {
      ...
      function d(l, g) {
        return g === 'role' ? g : 'aria-' + g.slice(4).toLowerCase();
      }
    },
  }),
  Bt = C({
    ...
    '../../node_modules/hastscript/node_modules/property-information/find.js'(e, r) {
      ...
      function g(x, S) {
        var k = t(S),
          w = S,
          A = n;
        return k in x.normal
          ? x.property[x.normal[k]]
          : (k.length > 4 &&
              k.slice(0, 4) === o &&
              u.test(S) &&
              (S.charAt(4) === '-' ? (w = h(S)) : (S = F(S)), (A = a)),
            new A(w, S));
      }
      function h(x) {
        var S = x.slice(5).replace(d, y);
        return o + S.charAt(0).toUpperCase() + S.slice(1);
      }
      function F(x) {
        var S = x.slice(4);
        return d.test(S) ? x : ((S = S.replace(l, b)), S.charAt(0) !== '-' && (S = '-' + S), o + S);
      }
      function b(x) {
  ...
  Ht = C({
    '../../node_modules/hast-util-parse-selector/index.js'(e, r) {
      ...
      var t = /[#.]/g;
      function a(n, o) {
        for (var u = n || '', d = o || 'div', l = {}, g = 0, h, F, b; g < u.length;)
          ((t.lastIndex = g),
            (b = t.exec(u)),
            (h = u.slice(g, b ? b.index : u.length)),
            h &&
              (F
                ? F === '#'
                  ? (l.id = h)
  ...
  Ut = C({
    '../../node_modules/hastscript/node_modules/comma-separated-tokens/index.js'(e) {
      ...
      var r = ',',
        ...
        a = '';
      function n(u) {
        for (var d = [], l = String(u || a), g = l.indexOf(r), h = 0, F = !1, b; !F;)
          (g === -1 && ((g = l.length), (F = !0)),
            (b = l.slice(h, g).trim()),
            (b || !F) && d.push(b),
            (h = g + 1),
      ...
      function o(u, d) {
        var l = d || {},
          g = l.padLeft === !1 ? a : t,
          h = l.padRight ? t : a;
        return (u[u.length - 1] === a && (u = u.concat(a)), u.join(h + r + g).trim());
      }
    },
  }),
  Gt = C({
    '../../node_modules/hastscript/factory.js'(e, r) {
      ...
      function l(k, w, A) {
        ...
        function s(f, m) {
          ...
          if (
            ...
            m && g(m, c) && (_.unshift(m), (m = null)),
            m)
          )
            for (E in m) p(c.properties, E, m[E]);
          return (
            F(c.children, _),
            c.tagName === 'template' &&
          ...
          c == null ||
            ...
            typeof E == 'string' &&
              (_.spaceSeparated
                ...
                : _.commaSeparated
                  ? (E = u(E))
                  : _.commaOrSpaceSeparated && (E = o(u(E).join(' ')))),
            v === 'style' && typeof c != 'string' && (E = x(E)),
            v === 'className' && f.className && (E = f.className.concat(E)),
            (f[v] = b(_, v, E)));
        }
      }
      function g(k, w) {
        return typeof k == 'string' || 'length' in k || h(w.tagName, k);
      }
      function h(k, w) {
        var A = w.type;
        return k === 'input' || !A || typeof A != 'string'
          ? !1
      ...
      function F(k, w) {
        ...
        if (typeof w == 'string' || typeof w == 'number') {
          k.push({ type: 'text', value: String(w) });
          return;
        }
        if (typeof w == 'object' && 'length' in w) {
          for (A = -1, i = w.length; ++A < i;) F(k, w[A]);
          return;
        }
      ...
      function b(k, w, A) {
        var i, s, p;
        if (typeof A != 'object' || !('length' in A)) return y(k, w, A);
        for (s = A.length, i = -1, p = []; ++i < s;) p[i] = y(k, w, A[i]);
        return p;
      }
      function y(k, w, A) {
        var i = A;
        return (
          k.number || k.positiveNumber
            ? !isNaN(i) && i !== '' && (i = Number(i))
            : (k.boolean || k.overloadedBoolean) &&
              typeof i == 'string' &&
              (i === '' || a(A) === a(w)) &&
              (i = !0),
          i
      ...
      function x(k) {
        var w = [],
          A;
        for (A in k) w.push([A, k[A]].join(': '));
        return w.join('; ');
      }
      function S(k) {
        for (var w = k.length, A = -1, i = {}, s; ++A < w;) ((s = k[A]), (i[s.toLowerCase()] = s));
        return i;
      }
    },
  }),
  ...
  en = C({
    '../../node_modules/refractor/node_modules/parse-entities/index.js'(e, r) {
      ...
      var O = 1,
        ...
        L = 7,
        $ = {};
      (($[O] = 'Named character references must be terminated by a semicolon'),
        ($[H] = 'Numeric character references must be terminated by a semicolon'),
        ($[z] = 'Named character references cannot be empty'),
        ($[X] = 'Numeric character references cannot be empty'),
        ($[J] = 'Named character references must be known'),
        ($[W] = 'Numeric character references cannot be disallowed'),
        ($[L] = 'Numeric character references cannot be outside the permissible Unicode range'));
      function B(j, I) {
        var T = {},
          K,
          P;
        I || (I = {});
        for (P in F) ((K = I[P]), (T[P] = K ?? F[P]));
        return (
      ...
      function Q(j, I) {
        var T = I.additional,
          ...
          q;
        for (
          typeof T == 'string' && (T = T.charCodeAt(0)), be = xe(), V = de ? ft : h, te--, Ce++;
          ++te < Ce;
        )
          if ((ne === y && (oe = gt[He] || 1), (ne = j.charCodeAt(te)), ne === k)) {
            if (
              ((D = j.charCodeAt(te + 1)),
              D === b ||
                D === y ||
            ...
            for (
              ue = te + 1,
                ...
                Ue = N[ee],
                q--;
              ++q < Ce && ((D = j.charCodeAt(q)), !!Ue(D));
            )
              ((U += g(D)), ee === c && l.call(t, U) && ((fe = U), (se = t[U])));
            ((ie = j.charCodeAt(q) === w),
              ie && (q++, (Ne = ee === c ? d(U) : !1), Ne && ((fe = U), (se = Ne))),
              (Y = 1 + q - ue),
              (!ie && !K) ||
                (U
                  ? ee === c
                    ? (ie && !se
                        ? V(J, 1)
                        : (fe !== U && ((q = ye + fe.length), (Y = 1 + q - ye), (ie = !1)),
                          ie ||
                            ((we = fe ? O : z),
                            I.attribute
                              ? ((D = j.charCodeAt(q)),
                                D === i ? (V(we, Y), (se = null)) : u(D) ? (se = null) : V(we, Y))
                              : V(we, Y))),
                      (R = se))
                    : (ie || V(H, Y),
                      (R = parseInt(U, E[ee])),
              ...
              R
                ? (Ge(),
                  ...
                  (_e = xe()),
                  _e.offset++,
                  re && re.call(Ee, R, { start: be, end: _e }, j.slice(ue - 1, q)),
                  (be = _e))
                : ((U = j.slice(ue - 1, q)), (le += U), (oe += U.length), (te = q - 1)));
          } else (ne === 10 && (Pe++, He++, (oe = 0)), ne === ne ? ((le += g(ne)), oe++) : Ge());
        return je.join('');
        function xe() {
          return { line: Pe, column: oe, offset: te + (Fe.offset || 0) };
        }
        function ft(Ze, We) {
          var Le = xe();
          ((Le.column += We), (Le.offset += We), de.call(he, $[Ze], Le, Ze));
        }
        function Ge() {
          le && (je.push(le), P && P.call(ge, le, { start: be, end: xe() }), (le = ''));
        }
      }
      function M(j) {
    ...
    '../../node_modules/refractor/node_modules/prismjs/components/prism-core.js'(e, r) {
      var t =
        ...
        a = (function (n) {
            ...
            l = {
              ...
              util: {
                encode: function i(s) {
                  return s instanceof g
                    ? new g(s.type, i(s.content), s.alias)
                    : Array.isArray(s)
                      ? s.map(i)
                      : s
                          .replace(/&/g, '&amp;')
                ...
                clone: function i(s, p) {
                  ...
                  switch (l.util.type(s)) {
                    case 'Object':
                      ...
                      ((f = {}), (p[m] = f));
                      for (var c in s) s.hasOwnProperty(c) && (f[c] = i(s[c], p));
                      return f;
                    case 'Array':
                      return (
                        (m = l.util.objId(s)),
              ...
              languages: {
                ...
                extend: function (i, s) {
                  ...
                  for (var f in s) p[f] = s[f];
                  return p;
                },
                insertBefore: function (i, s, p, f) {
                  f = f || l.languages;
                  var m = f[i],
                    c = {};
                  for (var _ in m)
                    if (m.hasOwnProperty(_)) {
                      if (_ == s) for (var v in p) p.hasOwnProperty(v) && (c[v] = p[v]);
                  ...
                  for (var _ in s)
                    if (s.hasOwnProperty(_)) {
                      ...
                      E === 'Object' && !m[c(v)]
                        ...
                        : E === 'Array' && !m[c(v)] && ((m[c(v)] = !0), i(v, p, _, m));
                    }
                },
              },
              plugins: {},
              ...
              highlightAllUnder: function (i, s, p) {
                ...
                (l.hooks.run('before-highlightall', f),
                  (f.elements = Array.prototype.slice.apply(
                    f.container.querySelectorAll(f.selector),
                  )),
                  l.hooks.run('before-all-elements-highlight', f));
                for (var m = 0, c; (c = f.elements[m++]);)
                  l.highlightElement(c, s === !0, f.callback);
              },
              highlightElement: function (i, s, p) {
                var f = l.util.getLanguage(i),
                  m = l.languages[f];
                l.util.setLanguage(i, f);
                var c = i.parentElement;
                c && c.nodeName.toLowerCase() === 'pre' && l.util.setLanguage(c, f);
                var _ = i.textContent,
                  v = { element: i, language: f, grammar: m, code: _ };
                function E(O) {
                  ((v.highlightedCode = O),
                ...
                } else E(l.highlight(v.code, v.grammar, v.language));
              },
              highlight: function (i, s, p) {
                var f = { code: i, grammar: s, language: p };
                if ((l.hooks.run('before-tokenize', f), !f.grammar))
                  throw new Error('The language "' + f.language + '" has no grammar.');
                return (
                  (f.tokens = l.tokenize(f.code, f.grammar)),
                  l.hooks.run('after-tokenize', f),
                  g.stringify(l.util.encode(f.tokens), f.language)
                );
              },
              tokenize: function (i, s) {
                ...
                var m = new b();
                return (y(m, m.head, i), F(i, m, s, m.head, 0), S(m));
              },
              hooks: {
                all: {},
                add: function (i, s) {
                ...
                run: function (i, s) {
                  var p = l.hooks.all[i];
                  if (!(!p || !p.length)) for (var f = 0, m; (m = p[f++]);) m(s);
                },
              },
              Token: g,
            };
          ...
          function F(i, s, p, f, m, c) {
            for (var _ in p)
              if (!(!p.hasOwnProperty(_) || !p[_])) {
                var v = p[_];
                v = Array.isArray(v) ? v : [v];
                for (var E = 0; E < v.length; ++E) {
                  if (c && c.cause == _ + ',' + E) return;
                  var N = v[E],
                    O = N.inside,
                    H = !!N.lookbehind,
                    z = !!N.greedy,
                  ...
                  for (
                    var W = N.pattern || N, L = f.next, $ = m;
                    L !== s.tail && !(c && $ >= c.reach);
                    $ += L.value.length, L = L.next
                  ) {
                    var B = L.value;
                    ...
                    if (!(B instanceof g)) {
                      var Q = 1,
                        M;
                      if (z) {
                        if (((M = h(W, $, i, H)), !M || M.index >= i.length)) break;
                        var T = M.index,
                          pe = M.index + M[0].length,
                          j = $;
                        for (j += L.value.length; T >= j;) ((L = L.next), (j += L.value.length));
                        if (((j -= L.value.length), ($ = j), L.value instanceof g)) continue;
                        for (
                          var I = L;
                          I !== s.tail && (j < pe || typeof I.value == 'string');
                          I = I.next
                        )
                          (Q++, (j += I.value.length));
                        (Q--, (B = i.slice($, j)), (M.index -= $));
                      ...
                      var T = M.index,
                        ...
                        de = $ + B.length;
                      c && de > c.reach && (c.reach = de);
                      var ge = L.prev;
                      (P && ((ge = y(s, ge, P)), ($ += P.length)), x(s, ge, Q));
                      var Ee = new g(_, O ? l.tokenize(K, O) : K, X, K);
                      if (((L = y(s, ge, Ee)), re && y(s, L, re), Q > 1)) {
                        var he = { cause: _ + ',' + E, reach: de };
                        (F(i, s, p, L.prev, $, he),
                          c && he.reach > c.reach && (c.reach = he.reach));
                      }
                    }
                  }
                }
          ...
          function y(i, s, p) {
            var f = s.next,
              m = { value: p, prev: s, next: f };
            return ((s.next = m), (f.prev = m), i.length++, m);
          }
          function x(i, s, p) {
            for (var f = s.next, m = 0; m < p && f !== i.tail; m++) f = f.next;
            ((s.next = f), (f.prev = s), (i.length -= m));
          }
          function S(i) {
                  ...
                  n.addEventListener(
                    ...
                    function (i) {
                      var s = JSON.parse(i.data),
                        ...
                        f = s.code,
                        m = s.immediateClose;
                      (n.postMessage(l.highlight(f, l.languages[p], p)), m && n.close());
                    },
                    !1,
                  )),
              l
          ...
          k && ((l.filename = k.src), k.hasAttribute('data-manual') && (l.manual = !0));
          function w() {
            l.manual || l.highlightAll();
          }
          if (!l.manual) {
            var A = document.readyState;
            A === 'loading' || (A === 'interactive' && k && k.defer)
  ...
  rn = C({
    '../../node_modules/refractor/core.js'(e, r) {
      ...
      function x(c) {
        ...
        y.languages[c.displayName] === void 0 && c(y);
      }
      function S(c, _) {
        var v = y.languages,
          E = c,
        ...
        _ && ((E = {}), (E[c] = _));
        for (N in E)
          for (O = E[N], O = typeof O == 'string' ? [O] : O, H = O.length, z = -1; ++z < H;)
            v[O[z]] = v[N];
      }
      function k(c, _) {
        var v = u.highlight,
        ...
        if (y.util.type(_) === 'Object') ((E = _), (_ = null));
        else {
          if (typeof _ != 'string')
            throw new Error('Expected `string` for `name`, got `' + _ + '`');
          if (F.call(y.languages, _)) E = y.languages[_];
          else throw new Error('Unknown language: `' + _ + '` is not registered');
        }
        return v.call(this, c, E, _);
      }
      function w(c) {
        if (typeof c != 'string')
          throw new Error('Expected `string` for `language`, got `' + c + '`');
        return F.call(y.languages, c);
      }
      function A() {
        var c = y.languages,
          _ = [],
          v;
        for (v in c) F.call(c, v) && typeof c[v] == 'object' && _.push(v);
        return _;
      }
      function i(c, _, v) {
        var E;
        return typeof c == 'string'
          ...
          : y.util.type(c) === 'Array'
            ...
            : ((E = {
                type: c.type,
                content: y.Token.stringify(c.content, _, v),
                tag: 'span',
              ...
              c.alias && (E.classes = E.classes.concat(c.alias)),
              y.hooks.run('wrap', E),
              n(E.tag + '.' + E.classes.join('.'), f(E.attributes), E.content));
      }
      function s(c, _) {
        for (var v = [], E = c.length, N = -1, O; ++N < E;)
          ((O = c[N]), O !== '' && O !== null && O !== void 0 && v.push(O));
        for (N = -1, E = v.length; ++N < E;) ((O = v[N]), (v[N] = y.Token.stringify(O, _, v)));
        return v;
      }
      function p(c) {
        return c;
...
function qe(e) {
  ...
  if (g) {
    var F = cn(t, o),
      b;
    if (!o) b = me(me({}, d), {}, { className: Xe(d.className) });
    else {
      var y = Object.keys(t).reduce(function (w, A) {
          return (
        ...
        x = d.className && d.className.includes('token') ? ['token'] : [],
        S =
          d.className &&
          x.concat(
      ...
      b = me(
        me({}, d),
        {},
        { className: Xe(S) || void 0, style: un(d.className, Object.assign({}, d.style, n), t) },
      );
    }
    var k = F(r.children);
    return G.createElement(g, vt({ key: u }, b), k);
  }
}
var pn = Z(kt()),
  dn = pn.default,
...
function Ae(e) {
  var r = e.children,
    ...
    b = e.wrapLines,
    y = b === void 0 ? !1 : b,
    x = y ? ae({}, typeof d == 'function' ? d(t) : d) : {};
  if (
    ((x.className = x.className ? [].concat(Te(x.className.trim().split(/\s+/)), Te(g)) : g),
    t && o)
  ) {
    var S = st(a, t, n);
    r.unshift(it(t, S));
  ...
  return (
    F & h && (x.style = ae({ display: 'flex' }, x.style)),
    { type: 'element', tagName: 'span', properties: x, children: r }
  );
}
function ut(e) {
  for (
...
function Un(e, r, t, a, n, o, u, d, l) {
  ...
  function k(p, f) {
    var m = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [];
    return r || m.length > 0 ? x(p, f, m) : S(p, f);
  }
  for (
    var w = function () {
      var p = h[y],
        f = p.children[0].value,
        m = Mn(f);
      if (m) {
        var c = f.split(`
`);
...
`,
          ...
          if (v === 0) {
            ...
            var z = h[y + 1] && h[y + 1].children && h[y + 1].children[0],
            ...
            if (z) {
              ...
              var W = [X],
                L = k(W, E, p.properties.className);
              F.push(L);
            }
          } else {
            var $ = [N],
              B = k($, E, p.properties.className);
            F.push(B);
          }
        }),
          (b = y));
  ...
  return function (t) {
    ...
    var Q = k
      ...
      j = x
        ...
        : Object.assign({}, B, {
            className: B.className ? ''.concat(pe, ' ').concat(B.className) : pe,
    ...
    (((c === void 0 && O) || v) && (c = !0), (O = O || Gn));
    var I = [{ type: 'text', value: L }],
      T = Zn({ astGenerator: $, language: o, code: L, defaultCodeValue: I });
    ...
    var K =
        ...
        a !== void 0
          ...
          : 0,
      P = s + K,
      re = Un(T, c, N, k, A, s, P, m, v);
    return G.createElement(
      z,
      j,
      G.createElement(J, b, !A && Q, O({ rows: re, stylesheet: l, useInlineStyles: x })),
    );
  };
}
var Be = Z(rn()),
...
function Kn({
  ...
  let h = ce.useCallback(
    (F) => {
      var y;
      g.current && clearTimeout(g.current);
      let b = typeof o == 'string' ? o : 'Copied to clipboard';
      (y = navigator.clipboard) == null ||
        y.writeText(t).then(() => {
          (a == null || a(F),
            l(!0),
            yt(b, 'polite'),
            (g.current = setTimeout(() => {
              (l(!1), bt('polite'), (g.current = null));
            }, u)));
        });
    },
    [t, a, o, u],
  ...
  return {
    children: d ? r : e,
    buttonProps: ce.useMemo(() => ({ onClick: h, ariaLabel: d ? o : n }), [h, d, o, n]),
  };
}
var Xn = {
  jsextra: bn,
...
Object.entries(Xn).forEach(([e, r]) => {
  ze.registerLanguage(e, r);
});
var Vn = (0, on.default)(2)((e) =>
  ...
  Jn = ({ children: e, className: r }) =>
    G.createElement(xt, { horizontal: !0, vertical: !0, focusable: !0, className: r }, e),
  Qn = ke(Jn)(
    { flex: 1, flexShrink: 0, flexBasis: 'fit-content', maxWidth: '100%' },
    ({ theme: e }) => Vn(e),
  ),
  ea = ke.pre(({ theme: e, padded: r }) => ({
    display: 'flex',
  ...
  na = ({ rows: e, stylesheet: r, useInlineStyles: t }) =>
    e.map((a, n) =>
      qe({ node: pt(a), stylesheet: r, useInlineStyles: t, key: `code-segement${n}` }),
    ),
  aa = (e, r) => (r ? (e ? ({ rows: t, ...a }) => e({ rows: t.map((n) => pt(n)), ...a }) : na) : e),
  dt = ({
    children: e,
    language: r = 'jsx',
    copyable: t = !1,
    ...
    let [h, F] = ce.useState('');
    ce.useEffect(() => {
      u ? u(o, e).then(F) : F(e.trim());
    }, [e, o, u]);
    let { children: b, buttonProps: y } = Kn({ content: h }),
      x = aa(g.renderer, l);
    return G.createElement(
      Yn,
      ...
      t
        ? G.createElement(ht, { actionItems: [{ title: b, onClick: y.onClick }], flexLayout: !0 })
        : null,
    );
  };
dt.registerLanguage = (...e) => ze.registerLanguage(...e);
var ia = dt;
export { dt as SyntaxHighlighter, ia as default, Xn as supportedLanguages };
