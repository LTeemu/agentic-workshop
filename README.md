...
| `app/server-utils/project-utils.js` | Shared project discovery, dependency, build, and run-command utilities     |
| `app/test-runner.js`                | Shared test execution logic                                                |
| `app/terminal.js`                   | Terminal PTY sessions (`node-pty`)                                         |
| `app/server-utils/color-utils.js`   | Terminal color helpers                                                     |
